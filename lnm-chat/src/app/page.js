...
import { UserCircleIcon, ArrowPathIcon, QrCodeIcon ,  ChevronLeftIcon, ChevronRightIcon, XMarkIcon  } from '@heroicons/react/24/outline';
      ...
      `}>
        ...
        {!isMobile && (
          <button 
            ...
            className="mt-auto p-2 hover:bg-gray-100 rounded-lg self-start"
          >
            {isSidebarOpen ? (
